 ...
 * 
 */
@WebServiceClient(name = "HelloWebServiceImplService", targetNamespace = "http://server.chiu.marcus.com/", wsdlLocation = "http://localhost:8080/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWEBSERVICEIMPLSERVICE_QNAME = new QName("http://server.chiu.marcus.com/", "HelloWebServiceImplService");
    ...
    public HelloWebService getHelloWebServiceImplPort() {
        return super.getPort(new QName("http://server.chiu.marcus.com/", "HelloWebServiceImplPort"), HelloWebService.class);
    }
    ...
    public HelloWebService getHelloWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.chiu.marcus.com/", "HelloWebServiceImplPort"), HelloWebService.class, features);
    }
