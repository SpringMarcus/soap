 ...
 * generated in the server.stuff package. 
...
public class ObjectFactory {
    ...
    private final static QName _PrintMessageResponse_QNAME = new QName("http://server.chiu.marcus.com/", "printMessageResponse");
    private final static QName _PrintMessage_QNAME = new QName("http://server.chiu.marcus.com/", "printMessage");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: server.stuff
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.chiu.marcus.com/", name = "printMessageResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.chiu.marcus.com/", name = "printMessage")
